...
import com.zuo.zoj.judge.codesandbox.CodeSanboxProxy;
import com.zuo.zoj.judge.codesandbox.CodeSandBoxFactory;
...
public class JudgeServiceImpl implements JudgeService{
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        questionSubmitUpdate.setStatus(QuestionSubmitStateEnum.RUNING.getValue());
        ...
        codeSandbox = new CodeSanboxProxy(codeSandbox);//代理模式
